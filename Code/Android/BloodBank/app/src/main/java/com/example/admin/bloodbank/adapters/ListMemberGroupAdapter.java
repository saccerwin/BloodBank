...
public class ListMemberGroupAdapter extends TemplateAdapter<ListMemberGroupAdapter.ItemVH>{
    ...
    public ListMemberGroupAdapter(List<Member> listItems) {
        this.listItems = listItems;
    }

    @Override
    public ItemVH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ListMemberGroupAdapter.ItemVH(this, parent);
    }
    ...
    public class ItemVH extends TemplateViewHolder {
        ...
        protected void initUI() {
            ...
            llLayoutProfileSearch.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View view) {
                    if (onClickItemListenerInterface != null) {
                        onClickItemListenerInterface.onLongClickItemListenner(view,getAdapterPosition());
                    }
                    return true;
                }
            });
